...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
        ...
        home: Scaffold(
          appBar: AppBar(
            title: const Text('custom paint implementation'),
          ),
          body: CustomPaint(
            painter: BluePainter(),
            child: Center(
...
class BluePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    Path ovalPath = Path();
    // moveto starts new subpath at given coordinate
    // start paint from 20% height to the left
    //create two curves which will get half of each
